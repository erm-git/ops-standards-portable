...
- Core docs contract: `srd/docs/authoring-standards/core-docs.md`
- Changelog rules: `srd/docs/authoring-standards/changelog.md`
- Markdown rules: `srd/docs/authoring-standards/markdown.md`
- MkDocs rules: `srd/docs/authoring-standards/mkdocs.md`
- YAML tasks rules: `srd/docs/authoring-standards/yaml-tasks.md`
- Python defaults: `srd/docs/authoring-standards/python.md`
- Skills (SKILL.md) authoring: `srd/docs/authoring-standards/skills.md`
- VS Code practices: `srd/docs/authoring-standards/vscode.md`
- Agent workflow templates: `srd/docs/authoring-standards/agent-workflows.md`
