...
Host-specific implementation notes belong under `srd/hosts/<host>/`.
...
See `srd/backup-standards.md`.

## Documentation structure (portable)

- Canonical standards: `srd/`
- Host-specific inventories/runbooks: `srd/hosts/<host>/`
