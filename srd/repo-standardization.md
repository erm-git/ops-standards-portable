...
6) **Sync the SRD block** in `AGENTS.md` with `scripts/sync-agents-srd.sh`.  
...
Reference: `srd/authoring-standards/markdown.md`
...
- `AGENTS.md` SRD block is synced via `scripts/sync-agents-srd.sh`.
